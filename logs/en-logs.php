...
if (!class_exists('EnUpsLfqLogs')) {
    class EnUpsLfqLogs
    {
        ...
        {
            $obj_classs = new \UPS_Curl_Request();
            $data = array(
                'serverName' => ups_ltl_get_domain(),
                'licenseKey' => get_option('ups_freight_setting_licnse_key'),
                'lastLogs' => '25',
                'carrierName' => 'ups',
            );
            ...
            $url = UPS_FREIGHT_DOMAIN_HITTING_URL . '/request-log/index.php';
            $logs = $obj_classs->ups_get_curl_response($url, $data);
