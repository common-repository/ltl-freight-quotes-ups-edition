 ...
 */
if (!class_exists('EnUpsOrderRates')) {

    class EnUpsOrderRates
    {
        ...
        public function en_order_before_calculate_totals($and_taxes, $order)
        {
            ...
            if (isset($woocommerce->cart)) {
                    ...
                    foreach ($shipping as $item_id => $per_shipment) {
                        ...
                        switch ($method_id) {
                            case 'ups_freight':
                                ...
                                if (empty($errors)) {
                                    $shipping_class = new UPS_Freight_Shipping_Class();
                ...
                if ($order_recreated) {
                    ...
                    $ups_freight_curl_obj = new UPS_Curl_Request();
                    $ups_freight_curl_obj->ups_get_curl_response(UPS_FREIGHT_FDO_HITTING_URL, $request_data);
                }
            }
        }
    }
