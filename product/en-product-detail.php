 ...
 * Class EnUpsFreightProductDetail
 * @package EnUpsFreightProductDetail
 */
if (!class_exists('EnUpsFreightProductDetail')) {
    ...
    class EnUpsFreightProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnUpsFreightProductDetail constructor.
         */
        ...
        {
            $en_plugin_name = 'LTL Freight Quotes - TForce Freight Edition';
            ...
            $plan_status['hazardous_material']['ups_freight'][] = 'ups_freight';
            ...
            $nesting_material = apply_filters("ups_freight_quotes_quotes_plans_suscription_and_features", 'nested_material');
            if (is_array($nesting_material)) {
                $plan_required = '1';
                $nested_material_status = $en_plugin_name . ': Upgrade to Advanced Plan to enable.';
            }

            $plan_status['nesting']['ups_freight'][] = 'ups_freight';
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['hazardous_material'])) {
                if (!in_array(0, $plan_status['hazardous_material']['plan_required'])) {
                    ...
                    $this->hazardous_plan_required = apply_filters("ups_freight_quotes_plans_notification_link", [2, 3]);
        ...
        public function en_product_input_field($custom_field, $postId)
        {
            ...
            if(isset($custom_field['id']) && $custom_field['id'] == '_nmfc_number') {
                $en_cf_value = get_post_meta($postId, $custom_field['id'], true);
                if(is_array($en_cf_value) && count($en_cf_value) > 0){
                    $en_cf_value = reset($en_cf_value);
                }
            } else {
                $en_cf_value = get_post_meta($postId, $custom_field['id'], true);
            }
