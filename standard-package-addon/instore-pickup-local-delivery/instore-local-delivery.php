...
if (!class_exists("EnUPSFreightWDQuotes")) {

    class EnUPSFreightWDQuotes
    {

        public function __construct()
        {
            add_filter('en_ups_freight_wd_update_query_string', array($this, 'en_ups_freight_wd_update_query_string'), 10, 1);
            add_filter('en_ups_freight_wd_origin_array_set', array($this, 'en_ups_freight_wd_origin_array_set'), 10, 1);
            add_filter('en_ups_freight_wd_standard_plans', array($this, 'en_ups_freight_wd_standard_plans'), 10, 4);
        ...
        public function en_ups_freight_wd_standard_plans($post_data, $destination_zip, $origin_array, $package_plugin)
        {
            $action = $this->check_package_plan($package_plugin);
            if ($action) {
                return $post_data;
         ...
         * @return string
         */
        public function en_ups_freight_wd_update_query_string()
        {
         ...
         * @return array type
         */
        public function en_ups_freight_wd_origin_array_set($origin)
        {
