...
//                    } else {
//                        $description = apply_filters('ups_freight_quotes_plans_notification_link', array(3));
...
//            }
            ...
            // Nesting Material plan status
            if (isset($plan_status['nesting'])) {
                if (!in_array(0, $plan_status['nesting']['plan_required'])) {
                    $disable_nested = 'disabled_me';
                    $description = apply_filters("ups_freight_quotes_plans_notification_link", [3]);
