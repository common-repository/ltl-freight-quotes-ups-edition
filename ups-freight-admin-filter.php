...
/**
 * Add UPS FREIGHT Method In WooCommerce Method List
 * @param array $methods
 * @return array
 */
    function add_ups_freight( $methods ) 
    {
        $methods['ups_freight'] = 'UPS_Freight_Shipping_Class';
        return $methods;
    }

/**
 * Add WooCommerce Setting Tab For UPS FREIGHT
 * @param $settings
 */
    
    function ups_freight_shipping_sections( $settings ) 
    {
        include( 'ups-freight-tab-class.php' );
        return $settings;
    }
 ...
 */
    ...
    function ups_freight_hide_shipping( $available_methods ) 
    {
        if (get_option('ups_freight_settings_allow_other_plugins') == 'no'
            ...
            foreach ($available_methods as $value) {
                if ($value->method_id == 'ups_freight') {
 ...
 */
function ups_freight_no_method_available() {
